from palavras import palavras #importando lista de palavras
import random #importando para randomizar palavras
...
def jogar(palavra):
  ...
  while not advinhou and tentativas > 0:
    ...
    if len(tentativa) == 1 and tentativa.isalpha():
      ...
      if tentativa in letras_utilizadas:
        print("Você já utilizou esta letra antes: ", tentativa)
    ...
    #Quando o usuário tenta advinhar a palavra toda da forca
      ...
      if tentativa in palavras_utilizadas:
        print("Você já utilizou está palavra  " , tentativa)
      #Palavra está errada
  ...
  if advinhou:
    ...
    print("Acabaram as tentivas, a palavra era: " , palavra)
